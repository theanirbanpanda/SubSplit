...
public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                Role hostRole = roleRepository.findByName("HOST")
                                .orElseGet(() -> roleRepository
                                                .save(Role.builder().name("HOST").description("Host User").build()));

                Role adminRole = roleRepository.findByName("ADMIN")
                                .orElseGet(() -> roleRepository.save(
                                                Role.builder().name("ADMIN").description("System Admin").build()));
                ...
                Category catProductivity = createCategoryIfNotFound("Productivity", "Workspace & design apps",
                                "Assignment");
                ...
                SubscriptionPlan sptfPlan = createPlanIfNotFound(sptf, "Family Plan 6 Screens", 6,
                ...
                SubscriptionPlan gptPlan = createPlanIfNotFound(gpt, "Team Workspace Pass", 5,
                ...
                SubscriptionPlan ytPlan = createPlanIfNotFound(yt, "Premium Family 5 Slots", 5,
                ...
                SubscriptionPlan cnvPlan = createPlanIfNotFound(cnv, "Pro Enterprise Team", 10,
                ...
                Subscription ms365 = createSubscriptionIfNotFound("Microsoft 365", catCloud,
                                ...
                                "https://office.com");
                SubscriptionPlan msPlan = createPlanIfNotFound(ms365, "Family 6 Members + 1TB", 6,
                                new BigDecimal("619.00"));
                ...
                SubscriptionPlan psPlan = createPlanIfNotFound(ps, "Deluxe Game Catalog Pass", 3,
        ...
        private User createAdminIfNotFound(String email, String password, String firstName, String lastName,
                        Role role) {
                return userRepository.findByEmail(email).orElseGet(() -> {
                        User user = User.builder()
                                        .email(email)
        ...
        private void createListingIfNotFound(User host, SubscriptionPlan plan, String title, String description,
